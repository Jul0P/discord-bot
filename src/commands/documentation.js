...
export default {
	...
	async execute(interaction) {
		const embed = new EmbedBuilder().setTitle("Documentation du Bot").setDescription("Voici la liste des commandes disponibles et leurs descriptions").setColor("#0099ff").setFields(
			{
				name: "\u200B",
